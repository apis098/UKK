...
@section('content')
            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <div class="page-header">
                        <div class="row">
                            <div class="col-sm-12">
                                <h3 class="page-title">Edit tugas {{ $task->name }}</h3>
                            </div>
                        </div>
                    </div>
                    <!-- /Page Header -->
                    ...
                    <div class="card">
                            ...
                            <div class="bank-inner-details">
                                <div class="row">
                                    <form id="updateForm" method="POST"
                                        action="{{ route('task.update', $task->id) }}"enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="col-lg-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="description" id="description" id="" cols="30" rows="10">{{ $task->description }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="point" id="point"
                                                    value="{{ $task->default_point }}" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12">
                                            <div class="form-group">
                                    ...
                                    <div class="wrapper mt-5">
                                        ...
                                        <section class="rounded uploaded-area">
                                            @forelse($task->atachments as $file)
                                                <li class="row" id="detail-element-${num}">
                                                    ...
                                                    <div class="col-lg-2 text-end">
                                                        <button type="button" class="align-items-center btn btn-link"
                                                            onclick="deleteAtachment($file->id)">
                                                            <p class="text-danger mt-3 fa-solid fa-circle-xmark"></p>
                                                        </button>
                                                    </div>
                                                </li>
                                            @empty
                        ...
                        <div class=" blog-categories-btn pt-0">
                            {{-- <div class="bank-details-btn ">
                                <a class="btn bank-cancel-btn me-2" id="fake-button" onclick="submitUploadForm()">Edit tugas</a>
                            </div> --}}
                            <div class="bank-details-btn ">
                                <button type="button" class="btn bank-cancel-btn me-2" id="fake-button" >Edit tugas</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- JavaScript -->
    <script>
        var submitButton = document.getElementById('fake-button');
        submitButton.onclick = function() {
            ...
            //     files.push(value);
            // });
            const inputFileElements = document.querySelectorAll('.file-input');
            
            const formData = document.getElementById('updateForm');
            // var uploadedFile = [];
            inputFileElements.forEach(function(inputFileElement) {
                var uploadedFile = inputFileElement.files[0];

                if (uploadedFile) {
                    files.append(inputFileElement.id, uploadedFile);
                }
            });
            ...
            var route = $('#updateForm').attr('action');
            $.ajax({
                url: route,
                method: "PUT",
                // processData: false,
                ...
                //     files
                // },
                success: function(response) { // Fungsi yang akan dijalankan jika permintaan berhasil
                    iziToast.success({
                        title: 'Sukses',
                        message: 'suksesssssssss',
                        position: 'topCenter'
                    });
                },
