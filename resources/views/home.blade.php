...
<!-- Mirrored from preschool.dreamstechnologies.com/template/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 03 Feb 2024 17:04:55 GMT -->
<head>
        <meta charset="utf-8">
				...
				<ul class="nav user-menu">
					...
					<li class="nav-item dropdown has-arrow new-user-menus">
						<a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
							<div class="user-img">
								<img class="rounded-circle" src="{{asset('/img/profiles/avatar-01.jpg')}}" width="31" alt="Ryan Taylor">
								<div class="user-text">
									<h6>Ryan Taylor</h6>
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
										...
										<table class="table star-student table-hover table-center table-borderless table-striped">
											...
											<tbody>
												...
												<tr>
													...
													<td class="text-nowrap">
														<a href="profile.html">
															<img class="rounded-circle" src="{{asset('/img/profiles/avatar-01.jpg')}}" width="25" alt="Star Students">
															Jolie Hoskins
														</a>
													</td>
												...
												<tr>
													...
													<td class="text-nowrap">
														<a href="profile.html">
															<img class="rounded-circle" src="{{asset('/img/profiles/avatar-03.jpg')}}" width="25" alt="Star Students">
															Pennington Joy
														</a>
													</td>
												...
												<tr>
													...
													<td class="text-nowrap">
														<a href="profile.html">
															<img class="rounded-circle" src="{{asset('/img/profiles/avatar-04.jpg')}}" width="25" alt="Star Students">
															Millie Marsden
														</a>
													</td>
												...
												<tr>
													...
													<td class="text-nowrap">
														<a href="profile.html">
															<img class="rounded-circle" src="{{asset('/img/profiles/avatar-05.jpg')}}" width="25" alt="Star Students">
															John Smith
														</a>
													</td>
													<td class="text-center">1185</td>
					...
					<div class="row">
						...
						<div class="col-xl-3 col-sm-6 co{l-12">
...
<!-- Mirrored from preschool.dreamstechnologies.com/template/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 03 Feb 2024 17:06:01 GMT -->
</html>